...
onMounted(async()=>{loading.value=true;try{student.value=(await find(route.params.id))?.student}catch(e){errorMessage.value='Não foi possível carregar o estudante.'}finally{loading.value=false}})
</script>
