        ...
        <div v-else class="grid grid-cols-4 gap-4 mb-6 mt-4 rounded-lg shadow-sm">
          ...
          <Card customClass="col-span-2" title="Desempenho Acadêmico">
            ...
            <div>
              ...
              <div class="flex items-center">
                ...
                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium" :class="student.grades.status === 'Aprovado' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'">
          ...
          <Card customClass="col-span-2" title="Ocorrências Recentes">
            <div v-if="student.occurrences.length > 0">
              <div v-for="occurrence in student.occurrences" :key="occurrence.id" class="mb-3 pb-3 border-b border-gray-100 last:border-0">
                <div class="flex justify-between items-start">
                  <div>
                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium mb-1" :class="occurrence.type === 'Disciplinar' ? 'bg-yellow-100 text-yellow-800' : 'bg-blue-100 text-blue-800'">
                      {{ occurrence.type }}
                    </span>
            ...
            <div class="mt-3 text-right">
              <Button v-if="can('occurrences', 'read')" to="/ocorrencias/ocorrencias/listar" customClass="text-sm bg-white border-gray-200 !text-gray-700 hover:bg-gray-50 !focus:ring-green-300">
                Ver todas
              </Button>
            </div>
          </Card>
