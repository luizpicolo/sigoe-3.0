    ...
    <div class="flex flex-col md:flex-row flex-1">
      ...
      <main class="flex-1 p-6">
        ...
        <div class="grid grid-cols-4 gap-4 mb-6 mt-4 rounded-lg shadow-sm">
          ...
          <Card customClass="col-span-1" title="Ações"><Button :disabled="!can('users', 'update')" variant="info" :to="`/administrador/usuarios/visualizar/${userId}/permissoes`" customClass="w-full"><i class="fa-solid fa-shield-halved"></i>Gerenciar Permissões</Button><Button :disabled="!can('users', 'update')" :to="`/administrador/usuarios/editar/${userId}`" customClass="mt-4 w-full"><i class="fa-solid fa-edit"></i>Editar Usuário</Button><Button :disabled="!can('users', 'destroy')" variant="danger" @click="deleteUser" customClass="mt-4 w-full"><i class="fa-solid fa-trash-alt"></i>Excluir Usuário</Button></Card>
